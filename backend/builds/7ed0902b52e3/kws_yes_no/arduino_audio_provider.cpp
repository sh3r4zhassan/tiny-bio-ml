...
#if TBML_PDM_CLK_PIN == 26 && TBML_PDM_DATA_PIN == 25
#warning "Using default PDM pins (CLK=26, DATA=25) — automatically defining TBML_USE_DEFAULT 1 to use Arduino PDM library."
#define TBML_USE_DEFAULT 1 
#endif
